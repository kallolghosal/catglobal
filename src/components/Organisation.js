                ...
                <Container>
                    ...
                    <Slider {...settings}>
                        ...
                        <div className="organisation-single wow fadeIn slick-slide slick-cloned">
                            ...
                            <a href="https://www.greenfoundation.in/" target="_blank" rel="noreferrer" className="organisation-readmore">READ MORE</a>
                        </div>
                        <div className="organisation-single wow fadeIn slick-slide slick-cloned">
                            ...
                            <a href="https://fuzhio.org/" target="_blank" rel="noreferrer" className="organisation-readmore">READ MORE</a>
                        </div>
                        <div className="organisation-single wow fadeIn slick-slide slick-cloned">
                            ...
                            <a href="https://upfront.global/" target="_blank" rel="noreferrer" className="organisation-readmore">READ MORE</a>
                        </div>
                        <div className="organisation-single wow fadeIn slick-slide slick-cloned">
                        ...
                        <div className="organisation-single wow fadeIn slick-slide slick-cloned">
                            ...
                            <a href="https://solvists.org/" target="_blank" rel="noreferrer" className="organisation-readmore">READ MORE</a>
                        </div>
                    </Slider>
                </Container>
            </div>
