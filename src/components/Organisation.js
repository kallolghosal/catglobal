                    ...
                    <Slider {...settings}>
                        <div className="organisation-single wow fadeIn slick-slide slick-cloned">
                            ...
                            <div className="organisation-details">
                                ...
                                <p><a href="https://vruttiimpactcatalysts.org/" target="blank"> Visit Website </a></p>
                            </div>
                            <a href="https://vruttiimpactcatalysts.org/" target="_blank" className="organisation-readmore">READ MORE</a>
                        </div>
                        <div className="organisation-single wow fadeIn slick-slide slick-cloned">
                            ...
                            <a href="https://www.greenfoundation.in/" target="_blank" className="organisation-readmore">READ MORE</a>
                        </div>
                        <div className="organisation-single wow fadeIn slick-slide slick-cloned">
                            ...
                            <a href="https://fuzhio.org/" target="_blank" className="organisation-readmore">READ MORE</a>
                        </div>
                        <div className="organisation-single wow fadeIn slick-slide slick-cloned">
                            ...
                            <a href="https://upfront.global/" target="_blank" className="organisation-readmore">READ MORE</a>
                        </div>
                        <div className="organisation-single wow fadeIn slick-slide slick-cloned">
                            ...
                            <a href="https://swastihc.org/" target="_blank" className="organisation-readmore">READ MORE</a>
                        </div>
                        <div className="organisation-single wow fadeIn slick-slide slick-cloned">
                            ...
                            <a href="https://solvists.org/" target="_blank" className="organisation-readmore">READ MORE</a>
                        </div>
                    </Slider>
                </Container>
            </div>
